...
class App extends Component {
  ...
  render() {
    const filteredMusic = this.state.music.filter((song) => {
      return (
        song.title.toLowerCase().includes(this.state.searchBox) ||
        song.artist.toLowerCase().includes(this.state.searchBox) ||
        song.album.toLowerCase().includes(this.state.searchBox) ||
        song.genre.toLowerCase().includes(this.state.searchBox)
      );
    });
